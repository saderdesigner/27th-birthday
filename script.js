$(document).ready(function() {
    $('.start').click(function(){
        $('.stage1').fadeOut();
        fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/cake_modal.png','Cùng làm bánh nha!','Hôm nay anh sẽ chỉ cho em tự làm bánh nè. Đầu tiên là trộn hết mọi thứ lại á, xong rùi thì mình decor cho đẹp hui. Have fun and happy birthday');
    })
    ...
    $('.mixer').click(function(){
        ...
        if(mixtimes == 6){
            $('.stage2').fadeOut();
            fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/mix_modal.png','Yeah!!! Trộn xong rồi nè','Thấy chưa, tích cực quay tay vận may sẽ tới...');
